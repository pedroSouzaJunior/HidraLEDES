...
public class HidraTest {
    ...
    public void persistAssset() throws DatatypeConfigurationException {
        ...
        assertEquals(true, db.insert(asset));
        ...
        assertEquals(true, db.insert(profile));
        ...
        assertEquals(true, db.insert(relatedAssets));
        ...
        assertEquals(true, db.insert(relatedAssetType));
        ...
        assertEquals(true, db.insert(context));
        ...
        assertEquals(true, db.insert(descriptionGroup));

        //inserção e validação da instancia artifactType
        assertEquals(true, db.insert(artifactType));
        ...
        assertEquals(true, db.insert(artifactActivy));
        ...
        assertEquals(true, db.insert(contextReference));
        ...
        assertEquals(true, db.insert(activity));
        ...
        assertEquals(true, db.insert(variabilityPointBinding));
